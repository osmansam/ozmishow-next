...
const TwoPicture4 = ({
  ...
  return (
    <div className="w-full h-full flex flex-col lg:flex-row-reverse bg-white rounded-3xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl border border-gray-100">
      ...
      <div className="p-8 flex flex-col gap-6 flex-grow lg:w-3/5 justify-center">
        ...
        <button
          className="w-fit group px-8 py-3 bg-white text-gray-900 border-2 border-gray-900 text-sm font-bold uppercase tracking-widest rounded-lg hover:bg-gray-900 hover:text-white transition-all duration-300 shadow-sm hover:shadow-lg transform hover:-translate-y-0.5"
          onClick={() => {
